...
(function(){
  ...
  hivMonthlySummaryFilterController.$inject=['$scope','$rootScope','SearchDataService','moment','$state','$filter','CachedDataService','OpenmrsRestService','LocationModel','ClinicDashboardService'];

  function hivMonthlySummaryFilterController($scope,$rootScope,SearchDataService,moment,$state,$filter,CachedDataService,OpenmrsRestService,LocationModel,ClinicDashboardService){
    $scope.forms=[];
    $scope.selectedForms={};
